...
#define KEY0_GPIO_PIN                   SYS_GPIO_PIN0
#define KEY0_GPIO_CLK_ENABLE()          do{ RCC->AHB1ENR |= 1 << 0; }while(0)   /* PA口时钟使能 */
...
#define KEY2_GPIO_PIN                   SYS_GPIO_PIN3
#define KEY2_GPIO_CLK_ENABLE()          do{ RCC->AHB1ENR |= 1 << 4; }while(0)   /* PE口时钟使能 */

#define KEY3_GPIO_PORT                  GPIOE
#define KEY3_GPIO_PIN                   SYS_GPIO_PIN4
#define KEY3_GPIO_CLK_ENABLE()          do{ RCC->AHB1ENR |= 1 << 4; }while(0)   /* PE口时钟使能 */

#define KEY0       sys_gpio_pin_get(KEY0_GPIO_PORT,KEY0_GPIO_PIN)      /* 读取WK_UP按键 */
